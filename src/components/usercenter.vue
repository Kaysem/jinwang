    ...
    <div class="top_content clearfix">
        ...
        <div class="fr t_c_r">
            ...
            <el-row>
                ...
                <el-col :span="4">
                    <p>入住会员时间：</p>
                    <p class="infoTip num">2017-12-14</p>
                </el-col>
                <el-col :span="4">
                    <p>最后一次到店时间：</p>
                    <p class="infoTip num">2018-08-02</p>
                </el-col>
                <el-col :span="8">
                    <p>地址：</p>
                    <p class="infoTip">北京市</p>
                </el-col>
            </el-row> 
  ...
  export default {
    ...
    data () {
      return {
        ...
        chart_kind :{
            option: {
                title : {"text": "常买商品","textStyle": {    "color": "#4080ff",    "fontWeight": "400",    "fontSize": 20},"top": "5%","left": "center"},backgroundColor:"rgba(0,0,0,0)",color: ['#4080ff'],
                tooltip: {trigger: 'axis',axisPointer: {    type: 'line',    lineStyle: {  opacity: 0    }},},
                grid: {left: '5%',right: '5%',bottom: '5%' ,top: '100',containLabel: true,z: 22 },
                label:{ normal:{     show: true,     position: 'top'}  },
                xAxis: [{
                    type: 'category',gridIndex: 0,axisTick: {show: false },splitLine:{  show:false  },axisLine: {  lineStyle: { color: '#4080ff' }},axisLabel: { "textStyle": {        "color": '#4080ff',    }},
                    data: ["苹果","安慕希","冰淇淋"], //name值
                }],
                yAxis: [
                    { type: "value",axisTick: {show: false }, splitLine:{  show:true ,lineStyle: {color: '#d4daf8',    } }, axisLine: {    lineStyle: {        color: '#4080ff',    }},axisLabel: {    "textStyle": {  "color": '#4080ff',    }}}
                ],
                series: [{
                        name: '',type: 'bar',barWidth: '10%',itemStyle: {    normal: {    color: '#4080ff' ,    barBorderRadius: 10,    }},
                        data: ["20","1","3"], //数值
                    },
                ]
            }
        ...
        chart_power:{
            option : {
                title : {"text": "竞争力分析","textStyle": {    "color": "#4080ff",    "fontWeight": "400",    "fontSize": 20},"top": "5%","left": "center"},backgroundColor:"rgba(0,0,0,0)",color: ['#4080ff'],
                tooltip: {trigger: 'axis',axisPointer: {    type: 'line',    lineStyle: {  opacity: 0    }}, 
                ...
                legend: {
                    data:['总消费','星座','年龄','性别'],
                    right:"0%", top:"10%",  textStyle: {"color": "#4080ff","fontWeight": "bold","fontSize": 10 },
                },
                grid: {left: '5%',right: '5%',bottom: '5%',top: '100',containLabel: true,z: 22 },
                xAxis : [{
                        type : 'category', axisTick: {show: false },splitLine:{      show:false  }, axisLine: {    lineStyle: {        color: '#4080ff',    }},axisLabel: {    "textStyle": {  "color": '#4080ff',    }},
                        data : ["1月","2yue","3yue"],
                }],
                yAxis : [ {                 
                    type : 'value', axisTick: {show: false }, splitLine:{  show:true ,lineStyle: {color: '#d4daf8',    } }, axisLine: {    lineStyle: {        color: '#4080ff',    }},
                    axisLabel: {    
                ...
                series : [
                    {
                        name:'总消费',
                        type:'bar', barWidth: '15',itemStyle: {    normal: {     color: "#5793f3",   barBorderRadius: 30,    }},
                        data:[1,3,5,2],
                    },
                    {
                        name:'星座',
                        type:'bar', barWidth: '15',itemStyle: {    normal: {    color: "#d14a61",     barBorderRadius: 30,    }},
                        data:[1,3,5,2],
                    },
                    {
                        name:'年龄',
                        type:'bar', barWidth: '15',itemStyle: {    normal: {     color: "#6666ff",   barBorderRadius: 30,    }},
                        data:[1,3,5,2],
                    },
                    {
                        name:'性别',
                        type:'bar', barWidth: '15',itemStyle: {    normal: {    color: "#00000b",     barBorderRadius: 30,    }},
                        data:[1,3,5,2],
                    }
                ]
            },
