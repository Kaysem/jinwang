 ...
 <div id="usercenter">
    ...
    <div class="center_top_box">
        ...
        <div class="center_top_box_right">
            <el-carousel height="390px" loop = "true" class="el_carousel__indicators">
                <el-carousel-item>
                  <table>
                      <tr>
                        <th>推荐商品</th>
                      ...
                      <tr>
                        <td>1</td>
                        <td>伊丽莎白雅顿Elizabeth Arden金胶</td>
                        <td><span>¥ </span><span>360</span></td>
                      </tr>
                      <tr>
                        <td>1</td>
                        <td>伊丽莎白雅顿Elizabeth Arden金胶</td>
    ...
    <div class="center_box">
        ...
        <div class="c_row">
            <el-row>
                ...
                <el-col :span="4">
                    <p class="c_tips"><span class="c_tips_num">32</span>件</p>
                    <p>购买件数</p>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                    <p class="c_tips"><span class="c_tips_num">80</span>%</p>
                    <p>购买率</p>
                </el-col>
            </el-row>
        </div>
...
.center_box >>> .el-range-input,.el-range-separator {
  color: #000;
}
